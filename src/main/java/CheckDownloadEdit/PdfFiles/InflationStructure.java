...
//                            System.out.println(++num);
                        ...
                        if (lines[j].contains("Услуги пассажирского")) {
                            if (lines[j+1].contains("транспорта")) {
                                rawLines.add(lines[j+1]);
...
//                            System.out.println(++num);
                        ...
                        if (lines[j].contains("Санаторно-оздоровительные")) {
                            if (lines[j+1].contains("услуги")) {
                                rawLines.add(lines[j+1]);
//                                System.out.println(lines[j+1]);
//                                System.out.println(++num);
                            }
...
//                                System.out.println(++num);
                        ...
                        if (lines[j].contains("Услуги дошкольного")) {
                            if (lines[j+1].contains("воспитания")) {
                                rawLines.add(lines[j+1]);
//                                System.out.println(lines[j+1]);
//                                System.out.println(++num);
                            }
