...
public class DepositsF {
    ...
    private String LINK_CURRENT = "https://www.cbr.ru/statistics/print.aspx?file=bank_system/4-2-1a_" +
            FilesUtil.CURRENT_YEAR +
            ".htm&pid=pdko_sub&sid=dpbvf";
    private String LINK_PREV = "https://www.cbr.ru/statistics/print.aspx?file=bank_system/4-2-1a_" +
